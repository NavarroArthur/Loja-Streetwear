...
const products = [
    {
        ...
        oldPrice: 199.90,
        image: "👔",
        imageFront: "FRENTE1.png",
        imageBack: "COSTAS1.png",
        badge: "Novo"
    },
    {
        id: 2,
        ...
        oldPrice: null,
        image: "👔",
        imageFront: "FRENTE2.png",
        imageBack: "COSTAS2.png",
        badge: null
    },
    {
        id: 3,
        ...
        oldPrice: null,
        image: "👔",
        imageFront: "FRENTE3.png",
        imageBack: "COSTAS3.png",
        badge: null
    }
];
    ...
    if (hasMultipleImages) {
        ...
        imageHTML = `
            <div class="product-image-container">
                <img src="${product.imageFront}" alt="${product.name} - Frente" class="product-img product-img-front">
                <img src="${product.imageBack}" alt="${product.name} - Costas" class="product-img product-img-back">
...
function setupBrandImage() {
    ...
    // Check if image has a src and it's not empty
    if (brandImage.src && brandImage.src !== window.location.href) {
